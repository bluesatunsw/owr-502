...
namespace drvconstants {
    ...
    constexpr float kHFI_Gain_Acc = 0.001f * _2PI;
    constexpr float kHFI_Gain_Vel = 4.0f * _2PI;
    constexpr float kHFI_Gain_Pos = 700.0f * _2PI;
    constexpr float kHFI_AngDeltaDiscardThresh = 0.08f;
    constexpr float kCurrentSenseAlignEffort_V = 4;

    constexpr HFIMotorData kTmotorG60{14, 3.4f, 25.0f, 1987e-6f, 1474e-6f}; // TODO:
